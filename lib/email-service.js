...
export async function sendFileNotification(options) {
  // ★ otp を受け取る
  const { to, from, subject, message, filename, fileSize, downloadUrl, expiresAt, otp } = options;
...
<p style="font-size: 18px; color: #000; background: #f4f4f4; padding: 10px; border-radius: 5px; letter-spacing: 2px;">
  <b>★ ダウンロード用OTP (ワンタイムパスワード): ${otp}</b>
</p>
